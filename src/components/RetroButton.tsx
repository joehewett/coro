...
const RetroButton = forwardRef<HTMLButtonElement, RetroButtonProps>(
  ({ className, size = "md", children, ...props }, ref) => {
    ...
    const buttonStyles =
      "bg-gray-100 text-gray-800 shadow-[0_6px_0_#d4d4d8,0_8px_8px_rgba(0,0,0,0.3)] hover:shadow-[0_8px_0_#d4d4d8,0_12px_12px_rgba(0,0,0,0.4)] hover:bg-white border-2 border-gray-300";
